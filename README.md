...
To enable live movie data and player content, add your TMDB bearer token:
...
If I were describing this project briefly to a recruiter or hiring team:

> I built a Netflix-inspired streaming front end in React with Firebase authentication, protected routes, TMDB-powered content rows, cinematic autoplay trailer behavior, and custom motion/overlay work built from scratch without GSAP or Framer templates.
